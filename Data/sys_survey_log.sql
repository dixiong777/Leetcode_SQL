...
--
-- Dumping data for table `survey_log`
--

LOCK TABLES `survey_log` WRITE;
/*!40000 ALTER TABLE `survey_log` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `survey_log` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2019-11-02 19:46:23
